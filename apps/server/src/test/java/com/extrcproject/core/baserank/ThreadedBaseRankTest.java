...
public class ThreadedBaseRankTest {

    private static final SatReasoner reasoner = new SatReasoner();
    private static final ThreadedBaseRank threadedBaseRank = new ThreadedBaseRank(reasoner);
    ...
    public void testWithEmptyKnowledgeBase() {
        ...
        var baseRank = threadedBaseRank.computeBaseRank(kb);
    ...
    public void testDefeasibleAndClassical() throws Exception {
        ...
        BaseRankResult baseRank = threadedBaseRank.computeBaseRank(kb);
